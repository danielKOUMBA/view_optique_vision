 ...
 async function handleView(){
    ...
    <div className="flex justify-center">
        <div className="absolute top-135 pb-35 ">
         ...
         <div className="absolute top-100 pb-30 w-full flex justify-center">
            <ul>
             <li>
                {info.map((inf)=>(
                    <div className='p-2 m-2 border border-black rounded-lg flex justify-between items-center gap-3' key={inf.id}>
